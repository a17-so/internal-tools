TEMPLATES = {
    "macro": {
        "subject": "PAID PARTNERSHIP OPPORTUNITY - Pretti App",
        "email_md": (
            "hey {name}\n\n"
            ...
            "we’re launching Pretti; an AI beauty app that gives you step-by-step guides to recreate any makeup look and helps you shop for the right products that match your style and skin.\n\n"
